                ...
                <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="masthead-device-mockup">
                            ...
                            ><svg class="shape-1 d-none d-sm-block" viewBox="0 0 240.83 240.83" xmlns="{{ asset('site10ass/http://www.w3.org/2000/svg') }}">
                            ...
                            <div class="device-wrapper">
                                <div class="device" data-device="iPhoneX" data-orientation="portrait" data-color="black">
                                    <div class="screen bg-black">
                                        ...
                                        <video muted="muted" autoplay="" loop="" style="max-width: 100%; height: 100%"><source src="{{ asset('site10ass/assets/img/demo-screen.mp4') }}" type="video/mp4" /></video>
                                    </div>
                                </div>
                            </div>
                        </div>
